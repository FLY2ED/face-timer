          ...
          <div className="space-y-4">
            {!isHttps && (
              <div className="flex items-start gap-3 p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                ...
                <div>
                  <h4 className="text-blue-400 text-sm font-medium">HTTP 환경 감지</h4>
            ...
            <div className="flex items-start gap-3 p-3 bg-zinc-800/50 rounded-lg">
              ...
              <div>
                <h4 className="text-white text-sm font-medium">개인정보 보호</h4>
                <p className="text-zinc-400 text-xs mt-1">
                  카메라 영상은 오직 집중도 분석에만 사용되며, 서버에 전송되거나 저장되지 않습니다.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3 bg-zinc-800/50 rounded-lg">
              ...
              <div>
                <h4 className="text-white text-sm font-medium">실시간 모니터링</h4>
                <p className="text-zinc-400 text-xs mt-1">
                  AI가 실시간으로 집중도를 분석하여 더 효과적인 학습을 도와드립니다.
                </p>
              </div>
            </div>
