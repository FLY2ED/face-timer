...
> ⚠️ **참고**: HTTP 환경에서는 웹캠 기능을 사용할 수 없습니다. HTTPS 또는 localhost 환경에서 실행해주세요.
...
3. 집중도가 떨어지면 경고 메시지와 함께 타이머가 일시정지됩니다

### 4. 통계 확인
1. 좌측 사이드바에서 "통계" 메뉴를 클릭합니다
2. 일별, 주별, 월별 학습 시간과 집중도를 확인할 수 있습니다
3. 작업별 시간 분배와 완료율을 분석할 수 있습니다
